...
//
const BotName = 'BOT ./BANGIQEBAL'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/muhammad.iqebal'; // Nama Instagramlu cok
const whatsapplu = '0823-7602-7363' // Nomor whatsapplu cok
const kapanbotaktif = 'Jam 8.00-24.00'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/KF3uSpLSvse70HfHzT6BaX'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/JY8vl8rZ29BBCAHbkmeZJj'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@BANGIQEBAL`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@BANGIQEBAL`)
})
...
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik #help ya bro..' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik #help ya bro..' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya bro..' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya bro..' ,MessageType.text);
}
...
/*   if (text.includes("#yt"))
   ...
   {
    var items = ["cewek hijab cantik", "cewe cantik", "hijab cantik", "korean girl"];
